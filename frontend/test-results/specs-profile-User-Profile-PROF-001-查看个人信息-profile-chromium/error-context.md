...
- Name: specs/profile.spec.ts >> User Profile >> PROF-001: 查看个人信息 @profile
- Location: tests/e2e/specs/profile.spec.ts:15:3
...
Locator: getByText('test@example.com')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('test@example.com')
