...
- Name: specs/trends.spec.ts >> Trends Analysis >> TREND-001: 查看围度趋势图 @trends
- Location: tests/e2e/specs/trends.spec.ts:12:3
...
Locator: locator('canvas').or(locator('[data-testid="chart"]'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('canvas').or(locator('[data-testid="chart"]'))
