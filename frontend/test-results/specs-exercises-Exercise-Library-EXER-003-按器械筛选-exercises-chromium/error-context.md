...
- Name: specs/exercises.spec.ts >> Exercise Library >> EXER-003: 按器械筛选 @exercises
- Location: tests/e2e/specs/exercises.spec.ts:30:3
...
Call log:
  - waiting for getByRole('button', { name: '杠铃' })
