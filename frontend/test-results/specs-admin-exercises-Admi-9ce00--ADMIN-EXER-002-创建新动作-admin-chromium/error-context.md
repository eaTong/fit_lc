...
- Name: specs/admin-exercises.spec.ts >> Admin - Exercise Management >> ADMIN-EXER-002: 创建新动作 @admin
- Location: tests/e2e/specs/admin-exercises.spec.ts:21:3
...
Call log:
  - waiting for getByRole('button', { name: '添加动作' })
