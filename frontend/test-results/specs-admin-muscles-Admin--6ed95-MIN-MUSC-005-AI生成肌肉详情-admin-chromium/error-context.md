...
- Name: specs/admin-muscles.spec.ts >> Admin - Muscle Management >> ADMIN-MUSC-005: AI生成肌肉详情 @admin
- Location: tests/e2e/specs/admin-muscles.spec.ts:64:3
...
Call log:
  - waiting for locator('[data-testid="muscle-row"]').first()
