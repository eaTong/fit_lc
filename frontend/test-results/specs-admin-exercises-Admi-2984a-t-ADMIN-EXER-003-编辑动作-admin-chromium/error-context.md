...
- Name: specs/admin-exercises.spec.ts >> Admin - Exercise Management >> ADMIN-EXER-003: 编辑动作 @admin
- Location: tests/e2e/specs/admin-exercises.spec.ts:38:3
...
Call log:
  - waiting for locator('[data-testid="edit-button"]').first()
