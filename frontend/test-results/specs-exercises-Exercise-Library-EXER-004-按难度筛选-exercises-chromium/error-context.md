...
- Name: specs/exercises.spec.ts >> Exercise Library >> EXER-004: 按难度筛选 @exercises
- Location: tests/e2e/specs/exercises.spec.ts:42:3
...
Call log:
  - waiting for getByRole('button', { name: '初级' })
