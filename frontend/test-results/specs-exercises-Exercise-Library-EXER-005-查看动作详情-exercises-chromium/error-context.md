...
- Name: specs/exercises.spec.ts >> Exercise Library >> EXER-005: 查看动作详情 @exercises
- Location: tests/e2e/specs/exercises.spec.ts:52:3
...
Call log:
  - waiting for locator('[data-testid="exercise-card"]').first()
