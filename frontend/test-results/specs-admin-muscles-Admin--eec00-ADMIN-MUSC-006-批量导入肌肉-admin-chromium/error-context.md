...
- Name: specs/admin-muscles.spec.ts >> Admin - Muscle Management >> ADMIN-MUSC-006: 批量导入肌肉 @admin
- Location: tests/e2e/specs/admin-muscles.spec.ts:76:3
...
Call log:
  - waiting for getByRole('button', { name: '批量导入' })
