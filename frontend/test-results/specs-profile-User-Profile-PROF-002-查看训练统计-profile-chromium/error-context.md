...
- Name: specs/profile.spec.ts >> User Profile >> PROF-002: 查看训练统计 @profile
- Location: tests/e2e/specs/profile.spec.ts:22:3
...
Call log:
  ...
  - waiting for getByText(/训练次数|总训练/)
