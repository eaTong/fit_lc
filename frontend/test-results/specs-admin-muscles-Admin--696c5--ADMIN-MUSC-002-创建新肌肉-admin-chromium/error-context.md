...
- Name: specs/admin-muscles.spec.ts >> Admin - Muscle Management >> ADMIN-MUSC-002: 创建新肌肉 @admin
- Location: tests/e2e/specs/admin-muscles.spec.ts:21:3
...
Call log:
  - waiting for getByRole('button', { name: '添加肌肉' })
