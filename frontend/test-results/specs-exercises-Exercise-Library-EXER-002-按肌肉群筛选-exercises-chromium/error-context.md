...
- Name: specs/exercises.spec.ts >> Exercise Library >> EXER-002: 按肌肉群筛选 @exercises
- Location: tests/e2e/specs/exercises.spec.ts:20:3
...
Call log:
  - waiting for getByRole('button', { name: '胸部' })
