...
- Name: specs/admin-exercises.spec.ts >> Admin - Exercise Management >> ADMIN-EXER-001: 查看动作列表(管理员) @admin
- Location: tests/e2e/specs/admin-exercises.spec.ts:13:3
