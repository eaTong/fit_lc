...
import RecentWorkoutItem from '../dashboard/RecentWorkoutItem';
import KeyMeasurementsPanel from '../dashboard/KeyMeasurementsPanel';
import PRCard from '../dashboard/PRCard';
import CumulativeStatsCard from '../dashboard/CumulativeStatsCard';
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-heading text-2xl font-bold">看板</h1>
        <Link
          to="/chat"
